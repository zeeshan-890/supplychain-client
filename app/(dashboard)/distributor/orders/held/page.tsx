...
export default function HeldOrdersPage() {
    ...
    if (isLoading) return <Container><div className="flex items-center justify-center min-h-[400px]"><Spinner size="lg" /></div></Container>;
    ...
    return (
        <Container>
            <div className="space-y-6">
                ...
                {(outgoingLegs?.filter((leg: any) => leg.status === 'REJECTED').length ?? 0) > 0 && (
                    <Card>
                        <CardHeader>
